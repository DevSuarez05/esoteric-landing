...
export default function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center justify-center group">
      ...
      {/* Perfect Circular WhatsApp Floating Button */}
      <a
        href={WHATSAPP_URL}
        target="_blank"
        ...
        className="relative w-14 h-14 rounded-full flex items-center justify-center bg-[#25D366] hover:bg-[#20ba5a] shadow-lg shadow-[#25D366]/40 hover:shadow-[#25D366]/70 hover:scale-110 active:scale-95 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2 focus:ring-offset-[#0B0914] cursor-pointer"
      >
        {/* Pulsing Halo Behind the Button */}
        <span className="absolute inset-0 rounded-full bg-[#25D366] animate-ping opacity-25 -z-10 pointer-events-none" />

        {/* Official White Centered WhatsApp SVG Icon */}
        <svg
          className="w-8 h-8 fill-white shrink-0 pointer-events-none"
          viewBox="0 0 24 24"
